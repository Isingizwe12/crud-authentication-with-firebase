  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6 text-white flex flex-col items-center">
      ...
      <div className="w-full max-w-2xl flex justify-between items-center mb-8">
        ...
        <button className="bg-red-600 px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-red-700 transition">
          <LogOut size={18} /> Logout
        </button>
      </div>

      {/* Greeting */}
      <p className="mb-6 text-lg text-gray-300">Hello, user@example.com</p>
